				...
				<div class="main">
					<div class="content-padding-2">
						<div class="container_12">
							...
							<form id="contact-form" enctype="multipart/form-data" method="post" action="entrar.php" >
											<fieldset>
								...
								<div class="footer-padding">
									<div class="wrapper">
										...
										<ul class="list-services">
											...
											<li><a class="tooltips n-2" title="Facebook" href="www.facebook.com"></a></li>
											<li class="last"><a class="tooltips n-3" title="Youtube" href="www.youtube.com"></a></li>
										</ul>
									</div>
